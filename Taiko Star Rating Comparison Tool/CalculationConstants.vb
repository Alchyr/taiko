Module CalculationConstants
    ...
    'base strain
    Public Const SPEED_DECAY_ONE As Double = 681.5
    Public Const SPEED_DECAY_TWO As Double = 680
    'These numbers mostly affect streams, but affect every map to some degree
    Public Const STREAM_BONUS As Double = 0.003 'caps at 50
    Public Const STREAM_BONUS_CAP As Double = STREAM_BONUS * 50 '0.15

    Public Const MAX_SWAP_BONUS_MULT As Double = 5

    Public Const BIG_SWAP_BONUS As Double = 0.2
    Public Const WEAK_SWAP_BONUS As Double = 0.1
    ...
    Public Const SPEEDUP_BIG_BONUS As Double = 0.5 'This number increases value of very extreme speed changes.
    ...
    'at end of stream
    Public Const SLOWDOWN_SMALL_BONUS As Double = 0.3 'in between - this affects 1/6
    Public Const SLOWDOWN_MEDIUM_BONUS As Double = 0.2 'half speed - this affects every map
    Public Const SLOWDOWN_BIG_BONUS As Double = 0.05 'extreme slowdown
