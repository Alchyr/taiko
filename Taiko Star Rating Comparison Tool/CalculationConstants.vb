Module CalculationConstants
    ...
    Public Const BASE_SPEED_VALUE As Double = 1.0 '0.8
    ...
    Public Const SWAP_SCALE As Double = 1.6

    Public Const FIRST_REPEAT_LOSS As Double = 0.75
    Public Const SECOND_REPEAT_LOSS As Double = 0.55
    Public Const EVEN_LOSS As Double = 0.65
    ...
    Public Const SPEEDUP_MEDIUM_BONUS As Double = 0.2 'speed doubling - this one affects pretty much every map other than stream maps
