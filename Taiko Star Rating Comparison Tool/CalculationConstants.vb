Module CalculationConstants
    ...
    Public Const SPEED_DECAY_ONE As Double = 680
    Public Const SPEED_DECAY_TWO As Double = 680
    ...
    Public Const MAX_SWAP_BONUS_MULT As Double = 7

    Public Const BIG_SWAP_BONUS As Double = 0.3
    ...
    Public Const SPEEDUP_SMALL_BONUS As Double = 0.5 'This number increases value of 1/6 and other weird rhythms.
    Public Const SPEEDUP_MEDIUM_BONUS As Double = 0.3 'speed doubling - this one affects pretty much every map other than very continuous long stream maps
    ...
    'Increasing this Moderate slowdown bonus, which mainly affects 1/6 -> 1/4 transitions, increases value of sustained 1/6 but not really buffing short sudden bursts
    'at end of stream
    Public Const SLOWDOWN_SMALL_BONUS As Double = 0.35 'in between - this affects 1/6
    Public Const SLOWDOWN_MEDIUM_BONUS As Double = 0.15 'half speed - this affects every map
