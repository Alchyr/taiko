Module CalculationConstants
    'new constants
    Public Const STAR_SCALING_FACTOR As Double = 0.0405
    ...
    'base strain
    Public Const BASE_SPEED_VALUE As Double = 1.05

    'color
    Public Const BASE_SWAP_BONUS As Double = 1.3 '0.8
    Public Const SWAP_SCALE As Double = 1.75 '1
    Public Const COLOR_BONUS_CAP As Double = 1.0

    Public Const SAME_POLARITY_LOSS As Double = 0.775
    ...
    Public Const SPEEDUP_BIG_BONUS As Double = 0.8 'This number increases value of anything that more than doubles speed. Affects doubles.
    ...
    Public Const SLOWDOWN_MEDIUM_BONUS As Double = 0.25 'half speed or more - this affects pretty much every map
